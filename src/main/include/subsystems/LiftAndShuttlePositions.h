...
constexpr double kLiftMiddleHatchPosition = 41;      // deliver hatch to middle rocket level
...
constexpr double kLiftCargoShipHatchPosition = 12; // deliver hatch to cargo ship
constexpr double kLiftClimbHab3Position = 28;
constexpr double kLiftClimbHab2Position = 12;

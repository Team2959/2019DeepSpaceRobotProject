...
constexpr double kLiftBottomHatchPosition = 17;   // pickup hatch or deliver hatch to bottom level
constexpr double kLiftCargoShipPosition = 28;   // deliver cargo to cargo ship
constexpr double kLiftMiddleCargoPosition = 42;      // deliver cargo to middle rocket level
constexpr double kLiftMiddleHatchPosition = 60;      // deliver hatch to middle rocket level
constexpr double kLiftTopCargoPosition = 85;         // deliver cargo to top rocket level
constexpr double kLiftTopHatchPosition = 95;         // deliver hatch to top rocket level
